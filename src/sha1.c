...
/*
 * Computes the SHA1 digest of the input char*
 *
 * @hash_out: The output pointer to write the SHA1 digest to.
 * 				This needs to be 21 bytes in length, since the SHA1 digest is 160 Bit in length.
 *				The last byte will always be '\0'
 * @str: The input pointer
 * @len: The length of the input value
 */
